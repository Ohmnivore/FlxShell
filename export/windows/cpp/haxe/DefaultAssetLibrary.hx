...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/FlxOS/bin/ls", Reflect.field (AssetType, "text".toUpperCase ()));
		...
		type.set ("assets/parseos.py", Reflect.field (AssetType, "text".toUpperCase ()));
...
class __ASSET__assets_flxos_bin_ls extends null { }
class __ASSET__assets_flxosjson_txt extends null { }
class __ASSET__assets_images_monaco_ttf extends null { }
class __ASSET__assets_images_monof55_ttf extends null { }
class __ASSET__assets_parseos_py extends null { }
